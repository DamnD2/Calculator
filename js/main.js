...
function getMathOperator(operator) {
  if (operator === document.querySelector('.plus').innerText) {
    return '+';
  } if (operator === document.querySelector('.minus').innerText) {
    return '-';
  } if (operator === document.querySelector('.multiply').innerText) {
    return '*';
  } if (operator === document.querySelector('.division').innerText) {
    return '/';
  }
  return false;
}
